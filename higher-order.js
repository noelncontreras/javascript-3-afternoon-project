...
//Code Here
let evenNumbers = mixedNumbers.filter(function(numbers) {
  return numbers % 2 === 0;
})

//evenNumbers = mixedNumbers.filter(numbers => numbers % 2 === 0); 
...
//Code Here
let postTaxPrices = prices.map(function(value) {
  return value * 1.07;
})
...
let totalPopulation = populations.reduce(function(addedPopulation, value) {
  return addedPopulation + value;
}, 0)
